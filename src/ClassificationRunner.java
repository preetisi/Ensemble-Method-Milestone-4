...
public class ClassificationRunner {
	...
	final static Class<?>[] CLASSIFIERS = { Vote.class };
//	final static Class<?>[] CLASSIFIERS = { AdaBoostM1.class };
	...
	public static void main(String[] args) throws Exception {
		if (args.length < 3) {
			System.err
					.println("Usage: ClassificationRunner <data dir> <output dir> <'old' or 'new'>");
		} else {
			String[] datasets;
			...
			new ClassificationRunner(args[0], args[1], datasets, CLASSIFIERS).runClassifiers();
		}
	}
